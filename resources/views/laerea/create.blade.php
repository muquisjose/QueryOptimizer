        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Crear linea aereas
                        <a href="" class="btn btn-primary float-end">Back</a>
                    </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{route('laereas.store')}}" method="POST">
                        @csrf
                        @method('post')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input type="text" class="form-control" name="aduana" placeholder="Ingrese el aduana" required>
                            </div>
                        </div>
                        <div class="col-3">
