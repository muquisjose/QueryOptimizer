...
<div class="container-fluid">
    <form action="{{route('bunches.store')}}" method="POST">
        @csrf
        @method('post')
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" readonly name="num_bunche" value="@if (isset($bunche->num_bunch))
                                    {{$bunche->num_bunch}}
                                @else
                                    A000001
                                @endif">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col">
                                <select name="bodega" id="bodega" class="form-control" required>
                                    ...
                                    <option value="2">Orden Fija</option>
                                    <option value="3">Reprocesado</option>
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col">
                                <input name="fecha" id="fecha" type="date" class="form-control-sm" value="{{date("Y-m-d")}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col">
                        ...
                        <div class="row form-group">
                            <div class="col">
                                <label for="mesa">Nº Bunches</label>
                            </div>
                            <div class="col">
                                <input type="number" class="form-control" name="nbunche" min="0">
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
