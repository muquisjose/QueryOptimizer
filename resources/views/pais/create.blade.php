        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Crear Paises
                ...
                <div class="card-body">
                    <form action="{{route('paises.store')}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input type="text" class="form-control" name="pais" placeholder="Ingrese el nombre" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input type="text" class="form-control" name="paraiso_fiscal" placeholder="Ingrese si es paraiso fiscal" required>
                            </div>
                        </div>
                        <div class="col-3">
